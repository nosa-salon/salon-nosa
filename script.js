...
function initEventListeners() {
    ...
    if (clientProductForm) {
        clientProductForm.onsubmit = function(e) {
            ...
            if (deliveryType !== 'pickup' && deliveryType !== 'nouran' && !addressVal) {
            ...
            if (deliveryType === 'nouran') deliveryTypeNameText = 'استلام من محل نوران شارع الشهيد';
            else if (deliveryType === 'local') deliveryTypeNameText = 'توصيل داخل القاهرة';
            ...
            const newBooking = {
                ...
                address: (deliveryType === 'pickup' || deliveryType === 'nouran') ? deliveryTypeNameText : addressVal
            };
            ...
            const addrGrp = document.getElementById('cp-address-group');
            if(addrGrp) addrGrp.classList.add('hidden');
